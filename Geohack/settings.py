"""
Django settings for Geohack project.
...
SECRET_KEY = 'qv-vyhr-q2kbit5%x2a_^g#k1m)g%q!f81jgdcu8r^hkd0y+h!'
...
WSGI_APPLICATION = 'Geohack.wsgi.application'
...
MASK_PATH = os.path.join(MEDIA_ROOT, 'masks')
